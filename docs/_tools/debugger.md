...
dl: <dl>
  ...
  <dt>
    <a id="console" name="console">Console Window</a>
  </dt>
  
 
  <dd>The debugger redirects the System.out, System.in, and System.err streams to an internal JavaScript console window which provides an editable command line for you to enter JavaScript code and view system output. The console window maintains a history of the commands you have entered. You may move backward and forward through the history list by pressing the Up/Down arrow keys on the keyboard.</dd>
  
 
  <dt>
    <a id="opening" name="opening">Opening Scripts</a>
  </dt>
  ...
  <dd>
    ...
    <strong>
     ...
     menu item on the menu bar to load JavaScript scripts contained in files. This action will display a file-selection dialog box prompting you for the location of a script to load. The selected file will be compiled and displayed in a new window.
  </dd>
  
 
  <dt>
    <a id="running" name="running">Running Scripts</a>
  </dt>
  ...
  <dd>
    ...
    <strong>
     ...
     menu item on the menu bar to execute JavaScript scripts contained in files. This action will display a file-selection dialog box prompting you for the location of a script to execute. The loaded script will be run in a new thread and control will be given to the debugger on its first instruction.
  </dd>
...
dl: <dl>
  ...
  <dt>
    <a id="stepinto" name="stepinto">Step Into</a>
  </dt>
  ...
  <dt>
    <a id="stepover" name="stepover">Step Over</a>
  </dt>
  ...
  <dt>
    <a id="stepout" name="stepout">Step Out</a>
  </dt>
  ...
  <dd>
    To give control to the debugger whenever a JavaScript is exception is thrown select the 
    <strong>
      <em>Debug-&gt;Break on Exceptions</em>
       
    </strong>
     checkbox from the menu bar. Whenever a JavaScript exception is thrown by a script a message dialog will be displayed and control will be given to the debugger at the location the exception is raised.
  </dd>
  ...
  <dd>
    Selecting 
    <strong>
      <em>Debug-&gt;Break on Function Enter</em>
       
    </strong>
     will give control to the debugger whenever the execution is entered into a function or script.
  </dd>
  ...
  <dd>
    Selecting 
    <strong>
      <em>Debug-&gt;Break on Function Return</em>
       
    </strong>
     will give control to the debugger whenever the execution is about to return from a function or script.
  </dd>
  ...
  <dd>The lower-left (dockable) pane in the debugger main window contains a combo-box labeled "Context:" which displays the current stack of the executing script. You may move up and down the stack by selecting an entry in the combo-box. When you select a stack frame the variables and watch windows are updated to reflect the names and values of the variables visible at that scope.</dd>
  
 
  <dt>
    <a id="setclearbkpts" name="setclearbkpts">Setting and Clearing Breakpoints</a>
  </dt>
  ...
  <dd>
    ...
    <ul>
      ...
      <li>
        Place the cursor on the line at which you want to set a breakpoint and right-click with the mouse. This action will display a pop-up menu. Select the 
        <strong>
          <em>Set Breakpoint</em>
    ...
    <ul>
      ...
      <li>
        Place the cursor on the line at which you want to clear a breakpoint and right-click with the mouse. This action will display a pop-up menu. Select the 
        <strong>
          <em>Clear Breakpoint</em>
...
dl: <dl>
  ...
  <dt>
    <a id="this" name="this">This</a>
  </dt>
  
 
  <dd>
    The properties of the current object are displayed in the 
    <strong>
      <em>this</em>
       
    </strong>
     table. If a property is itself a JavaScript object the property may be expanded to show its sub-properties. The 
    <strong>
      <em>this</em>
       
    </strong>
     table is updated each time control returns to the debugger or when you change the stack location in the 
    <strong>
      <em>Context:</em>
  ...
  <dt>
    <a id="locals" name="locals">Locals</a>
  </dt>
  
 
  <dd>
    The local variables of the current function are displayed in the 
    <strong>
      <em>Locals</em>
       
    </strong>
     table. If a variable is itself a JavaScript object the variable may be expanded to show its sub-properties. The 
    <strong>
      <em>Locals</em>
  ...
  <dd>
    ...
    <strong>
     ...
     table located in the lower-right (dockable) pane in the debugger main window. The expressions you enter are re-evaluated in the current scope and their current values displayed each time control returns to the debugger or when you change the stack location in the 
    <strong>
      <em>Context:</em>

...
Specifies the language version to compile with. The string _versionNumber_ must be one of `100`, `110`, `120`, `130`, `140`, `150`, `160 or 170`. See [JavaScript Language Versions](../docs/overview#javascript_language_versions.md) for more information on language versions.
